...
urlpatterns = [
    ...
    path('documentos/categoria/nueva/',                           views.crear_categoria_documento,     name='crear_categoria_documento'),
    path('documentos/categoria/<int:pk>/eliminar/',               views.eliminar_categoria_documento,  name='eliminar_categoria_documento'),
    path('documentos/categoria/<int:categoria_id>/subir/',        views.subir_documento,               name='subir_documento'),
    path('documentos/<int:pk>/eliminar/',                         views.eliminar_documento,            name='eliminar_documento'), 
    path('documentos/categoria/<int:pk>/',                        views.categoria_detalle,             name='categoria_detalle'),
]